...
#define MACHINE_UUID "53be5e54-6573-48a4-9e9e-a9d66d3ee392"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {55.5, 55.5, 55.5, 760*1.1}  // default steps per unit for Kossel (GT2, 20 tooth)
